...
//        this.setRound(10);
        ...
        MySubmitButton reciptUploadButton = new MySubmitButton("Upload Recipt");

        panel.add(reciptUploadButton, "split 3 , al center");
        panel.add(new MyResetButton("Clear"), "al center");
